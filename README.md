...
Detail                      | Description
--------------------------- | ----------------------
**Plugin identifier**       | intranda_workflow_excel_metadata_import
**Plugin type**             | workflow
**Licence**                 | GPL 2.0 or newer
**Documentation (German)**  | https://docs.goobi.io/de/workflow/plugins/workflow/goobi-plugin-workflow-excel-metadata-import
**Documentation (English)** | https://docs.goobi.io/en/workflow/plugins/workflow/goobi-plugin-workflow-excel-metadata-import
